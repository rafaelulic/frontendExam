<template>
  <div class="searp-card" @click="activateCard" :class="{active: isActive}">
    ...
    <div class="card-body">
      <div class="percentage">
        <span class="pill" :style="{backgroundColor: color}">
          ...
          <i :class="{hide: !isNegative}" class="material-icons"
          >arrow_upward</i>
          <i :class="{hide: isNegative}" class="material-icons">arrow_downward</i>
        </span>
      </div>
      <div class="actual-data">
        ...
        <span class="data">{{records.data2}}</span>
      </div>
    </div>
    <div class="card-footer">
        {{records.percentage}} increase in 30 days
    </div>
  </div>
</template>
